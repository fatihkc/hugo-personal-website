...
![Cloud Resume Challenge Steps](/images/cloud-resume-challenge-steps.jpg)
...
![Diagram](/images/diagram.png?style=centerme)
...
AWS Cloud Practioner, AWS Solutions Architect - Associate, and Certified Kubernetes Administrator are my main targets for now. Why Cloud Practioner? I can easily get it without even looking at example questions. My main goal is to learn the process of certification in AWS. It won’t be hard and I won’t be stressed about it. That way, Solutions Architect - Associate will be easier than before. Also, an additional certificate won’t hurt. CKA will be the last one and then I will create a new roadmap for my career. 
